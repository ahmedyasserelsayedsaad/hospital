...
//creat function
let carr;
if(localStorage.productnuc!=null){
    carr=JSON.parse(localStorage.productnuc)
}else{
    carr=[];
}
creat.onclick=()=>{
...
if(mood==='create'){
    ...
    localStorage.setItem('productnuc',JSON.stringify(carr));
...
function dindex(i){
 carr.splice(i,1);
 localStorage.productnuc=JSON.stringify(carr);
 showdata();
}
