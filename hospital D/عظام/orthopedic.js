...
//create
let myarr;
if(localStorage.prorr!=null){
    myarr=JSON.parse(localStorage.prorr)
}
else{
    myarr=[];
}
create.onclick=()=>{
    ...
    localStorage.setItem('prorr',JSON.stringify(myarr));
...
function  deleteindex(i){
    myarr.splice(i,1);
    localStorage.prorr=JSON.stringify(myarr);
    showdata();
}
